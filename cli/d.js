...
function checkAnswer(selectedButton, correctMeaning) {
    ...
    if (selectedAnswer === correctMeaning) {
        ...
        feedbackElement.textContent = 'Giỏi lắm con chó ơi';
        score++;
    } else {
        selectedButton.classList.add('incorrect');
        feedbackElement.textContent = `Óc cứttttt à??????: ${correctMeaning}`;
...
function endQuiz() {
    questionTextElement.textContent = `Mày cuối cùng cũng xong à th ngu : ${score}/${shuffledQuestions.length} điểm.`;
